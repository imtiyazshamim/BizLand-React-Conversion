  ...
  return (
    <header id="header" className={`fixed-top ${headerScrolled ? 'header-scrolled' : ''}`}>
      <div className="container d-flex align-items-center">
        <h1 className="logo me-auto"><a href="index.html">BizLand<span>.</span></a></h1>
        ...
        <nav id="navbar" className={`navbar ${isNavCollapsed ? '' : 'navbar-mobile'}`}>
          <ul>
            ...
            <li><a className={`nav-link scrollto ${activeLink === '#about' ? 'active' : ''}`} href="#about-2" onClick={scrollTo}>About</a></li>
